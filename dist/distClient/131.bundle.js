"use strict";
(self.webpackChunktemplate_app = self.webpackChunktemplate_app || []).push([[131], { 2131: function (e, t, n) { n.r(t), n.d(t, { getCLS: function () { return y; }, getFCP: function () { return g; }, getFID: function () { return C; }, getLCP: function () { return P; }, getTTFB: function () { return D; } }); var i, r, a, o, u = function (e, t) { return { name: e, value: void 0 === t ? -1 : t, delta: 0, entries: [], id: "v2-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12) }; }, c = function (e, t) { try {
        ...
        } }, v = c("layout-shift", p); v && (n = m(i, r, t), f((function () { v.takeRecords().map(p), n(!0); })), s((function () { a = 0, T = -1, r = u("CLS", 0), n = m(i, r, t); }))); }, E = { passive: !0, capture: !0 }, w = new Date, L = function (e, t) { i || (i = t, r = e, a = new Date, F(removeEventListener), S()); }, S = function () { if (r >= 0 && r < a - w) {
        ...
        } }, F = function (e) { ["mousedown", "keydown", "touchstart", "pointerdown"].forEach((function (t) { return e(t, b, E); })); }, C = function (e, t) { var n, a = l(), p = u("FID"), v = function (e) { e.startTime < a.firstHiddenTime && (p.value = e.processingStart - e.startTime, p.entries.push(e), n(!0)); }, d = c("first-input", v); n = m(e, p, t), d && f((function () { d.takeRecords().map(v), d.disconnect(); }), !0), d && s((function () { var a; p = u("FID"), n = m(e, p, t), o = [], r = -1, i = null, F(addEventListener), a = v, o.push(a), S(); })); }, k = {}, P = function (e, t) { var n, i = l(), r = u("LCP"), a = function (e) { var t = e.startTime; t < i.firstHiddenTime && (r.value = t, r.entries.push(e), n()); }, o = c("largest-contentful-paint", a); if (o) {
            n = m(e, r, t);
            var p = function () { k[r.id] || (o.takeRecords().map(a), o.disconnect(), k[r.id] = !0, n(!0)); };
            ["keydown", "click"].forEach((function (e) { addEventListener(e, p, { once: !0, capture: !0 }); })), f(p, !0), s((function (i) { r = u("LCP"), n = m(e, r, t), requestAnimationFrame((function () { requestAnimationFrame((function () { r.value = performance.now() - i.timeStamp, k[r.id] = !0, n(!0); })); })); }));
